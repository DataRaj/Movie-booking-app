...
import com.dat.proj.backend.service.impl.GenericServiceImpl;
...
public class GenericController {
    ...
    public ResponseEntity<Object> bookSeats(@RequestBody List<SeatMatrix> seatsToBook,
        ...
        try {
            ...
            try {
                bookingDetails = this.genericService.bookSeats(seatsToBook, userName);
            } catch (CinemaGruvhException e) {
                e.printStackTrace();
            } // in above bookingDetails, It required me to through the exception, So I added this exception.
